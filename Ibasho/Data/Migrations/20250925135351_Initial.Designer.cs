...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ibasho.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Ibasho.Data.Entities.Follow", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Ibasho.Data.Entities.Notification", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Ibasho.Data.Entities.Post", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Ibasho.Data.Entities.PostLike", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Ibasho.Data.Entities.Follow", b =>
                {
                    b.HasOne("Ibasho.Data.ApplicationUser", "Followee")
                        .WithMany("Followers")
                    ...
                    b.HasOne("Ibasho.Data.ApplicationUser", "Follower")
                        .WithMany("Following")
            ...
            modelBuilder.Entity("Ibasho.Data.Entities.Notification", b =>
                {
                    b.HasOne("Ibasho.Data.ApplicationUser", "ActorUser")
                        .WithMany()
                    ...
                    b.HasOne("Ibasho.Data.Entities.Post", "Post")
                        .WithMany()
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_notifications_posts_post_id");

                    b.HasOne("Ibasho.Data.ApplicationUser", "User")
            ...
            modelBuilder.Entity("Ibasho.Data.Entities.Post", b =>
                {
                    b.HasOne("Ibasho.Data.Entities.Post", "ParentPost")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Ibasho.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
